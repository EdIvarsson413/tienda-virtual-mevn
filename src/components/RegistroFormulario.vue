...
const registrar = async () => {
    ...
    try {
        // Cuadno se obtiene la respuesta, se saca el data
    ...
    <v-container>
        <v-card class="mx-auto mt-10" color="grey-darken-4" elevation="5" max-width="600">
            ...
            <v-form autocomplete="off">
                <v-card-text>
                    <!-- Nombre de usuario -->
                    <v-text-field v-model="userName" class="mb-3" label="Nombre de usuario" variant="outlined"
                        color="orange-darken-1" />

                    <!-- correo -->
                    <v-text-field v-model="correo" :rules="reglas.correo" class="mb-3" label="Correo electrónico"
                        variant="outlined" color="orange-darken-1" />

                    <!-- Contraseña -->
                    <v-text-field v-model="contrasena" :rules="reglas.contrasena" class="mb-3" label="Contraseña"
                        variant="outlined" color="orange-darken-1" type="password" />

                    <!-- Repetir contraeña -->
                    <v-text-field v-model="repetirContrasena" :rules="reglas.repetir" class="mb-3"
                        label="Repetir contraseña" variant="outlined" color="orange-darken-1" type="password" />
                </v-card-text>
