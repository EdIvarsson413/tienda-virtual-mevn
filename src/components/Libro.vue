...
const obtenerLibro = async () => {
    try {
        ...
        // Si obtiene el libro lo trae a la variable
        libro.value = data;
    } catch ( error ) {
...
// Se extrae el libro antes de montar el componente
onMounted( () => {
    obtenerLibro();
});
...
<template>
    <v-container v-if="mensaje === ''" class="mt-10">
        <v-row>
            <v-col 
                sm="12" 
                :md="rol !== 'publico' && usuario.role === 'user' ? 7 : 8"
                :class="rol === 'publico' || usuario.role !== 'user' ? 'mx-auto' : ''"
            >
                ...
                >
                    <v-row>
                        ...
                        <v-col cols="6">
                            <v-img max-width="350" :src="`https://firebasestorage.googleapis.com/v0/b/libreriascastor-ecffa.appspot.com/o/folder%2F${libro.imagen}?alt=media`" />
                        </v-col>
                            ...
                            <v-main>
                                ...
                                <v-card-actions>
                                    ...
                                    <v-btn 
                                        ...
                                        :disabled="rol === 'publico' || usuario.role !== 'user'"
                                    >
                                        Agregar al carrito
                                    </v-btn>
                                    <!-- Ir a la sinopsis -->
            ...
            <v-col v-if="!cambiar" sm="12" md="5">
                <Valoracion v-if="rol !== 'publico' && rol === 'user'" :nombreLibro="libro.nombre"/>
            </v-col>
        </v-row>
